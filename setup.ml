...
(* OASIS_START *)
(* DO NOT EDIT (digest: fc69066c0e2d55c7e27b1c724942b7d2) *)
(*
...
# 21 "/home/smondet/usr/oasis-0.3.0~rc5/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$tests_main", []))];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build Lwt dependencies";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build apps";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Flag
                 ({
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources =
                        ["biocaml_pwm_stub.c"; "biocaml_mzData_stubs.c"];
                      bs_data_files = [];
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Install documentation";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "installdoc", true)
                        ];
     ...
     oasis_digest = Some "sQ&S.n\002\197\158\157\2018\231j\251\253";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
