...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5ef917511ffd2b6e566e78997ca32b4a) *)
(*
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "biocamlsesame";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
