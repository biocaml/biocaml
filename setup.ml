...
(* OASIS_START *)
(* DO NOT EDIT (digest: f648a9d297f349bf2b4f2f591499a2b4) *)
(*
...
# 21 "/home/pveber/.odb/install-oasis/oasis-0.2.1~alpha1/src/plugins/custom/CustomPlugin.ml"
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["biocaml_pwm_stub.c"];
                      bs_data_files = [];
