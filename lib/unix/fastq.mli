...
(******************************************************************************)
val name_of_line : ?pos:Biocaml.Pos.t -> Biocaml.Line.t -> string Or_error.t
val sequence_of_line : ?pos:Biocaml.Pos.t -> Biocaml.Line.t -> string
val comment_of_line : ?pos:Biocaml.Pos.t -> Biocaml.Line.t -> string Or_error.t
