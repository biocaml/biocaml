...
module MakeIO (Future : Future.S) : sig
  ...
  val write : Writer.t -> ?header:header -> alignment Pipe.Reader.t -> unit Deferred.t
...
val parse_header_item : Biocaml.Line.t -> header_item Or_error.t
...
val parse_alignment : ?ref_seqs:String.Set.t -> Biocaml.Line.t -> alignment Or_error.t
