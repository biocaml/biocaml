...
val of_channel :
  ?chr_map:(string -> string) -> ?increment_bp:int -> In_channel.t -> t
...
val to_channel :
  ?chr_map:(string -> string) -> ?increment_bp:int -> t -> Out_channel.t -> unit

val to_file :
  ?chr_map:(string -> string) -> ?increment_bp:int -> t -> string -> unit
