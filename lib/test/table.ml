...
let test_row () =
  ...
  tdash "42-42.-42"
    (Ok [| `int 42; `float 42.; `string "42" |])
    ~to_line:"42-42-42";

  tdash "42-42.-42-any-string-42"
    (Ok
       [|
         `int 42;
         `float 42.;
