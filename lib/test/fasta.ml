...
module Parser0 = struct
  type parsing_result = (Fasta.item0 list, Fasta.parser_error) result [@@deriving sexp]
...
module Parser = struct
  type parsing_result = (Fasta.item list, Fasta.parser_error) result [@@deriving sexp]
...
let tests = "Fasta" >::: [ "parser0" >:: Parser0.test; "parser" >:: Parser.test ]
