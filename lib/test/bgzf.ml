...
let test_parse_past_eof () =
  ...
  Utils.with_temp_file "test" ".bgzf" ~f:(fun fn ->
      ...
      assert_raises ~msg:"Reading past end of file should raise" End_of_file
        (fun () -> with_file_in fn ~f:(fun iz -> input_string iz 4)))
...
let tests =
  ...
  >::: [
         ...
         "Parse bgzf_01"
         >:: test_parse_file_per_char (Utils.test_file "bgzf_01.bgzf");
         "Parse bgzf_02"
         >:: test_parse_file_per_char (Utils.test_file "bgzf_02.bgzf");
       ]
